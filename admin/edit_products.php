...
require'../includes/edit_products.php';
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
              ...
              <div class="col-md-6">
                <!-- <div class="form-label-group"> -->
                  ...
                  <input type="text" name="filmName" value="<?php if(isset($filmName)) {echo $filmName;} ?>" class="form-control" placeholder="Film Name" required="required">
            ...
            <div class="form-row">
              <div class="col-md-6">
                <!-- <div class="form-label-group"> -->
                  ...
                  <input type="text" name="filmPrice" value="<?php if(isset($filmPrice)) {echo $filmPrice;} ?>" class="form-control" placeholder="Film Price" required="required">
              ...
              <div class="col-md-6">
                <!-- <div class="form-label-group"> -->
                  ...
                  <input type="text" name="filmDetails" class="form-control" value="<?php if(isset($filmDetails)) {echo $filmDetails;} ?>" placeholder="Film Details" required="required">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="film_id" value="<?php if(isset($film_id)) {echo $film_id;} ?>" >
          </div>
